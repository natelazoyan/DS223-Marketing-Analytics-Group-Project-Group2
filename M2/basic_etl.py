...
from etl.data_preparation.schema import Sale 
...
import pandas as pd
data2=pd.read_csv('property.csv')
...
data5 = pd.read_csv('sales.csv').to_dict(orient='records')
